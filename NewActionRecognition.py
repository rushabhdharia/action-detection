...
from tensorflow.keras.layers import ConvLSTM2D, TimeDistributed, Attention, Dense, Flatten, MaxPool3D, MaxPool2D,BatchNormalization, Conv3D
...
class newGen(Sequence):
    ...
    def __init__(self, x_path, folder_name, y_path, to_fit = True, batch_size = 1, seq_len =10):
        ...
        self.all_frames, self.targets = self.check(self.all_frames, self.targets)
    ...
    def __getitem__(self, index):
        ...
        return tf.cast(X, tf.float16), tf.cast(Y, tf.uint8)
